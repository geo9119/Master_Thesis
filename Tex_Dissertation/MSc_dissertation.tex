...
In the following stacked histogram, it can be seen the post GBDT reduction of background and in the table 
...
\begin{figure}[ht!]
\centering
  \includegraphics[width=0.8\linewidth]{{images/postbdtcut_bdtg_3000}.pdf}
  \caption{\scriptsize{}}
\end{figure}
