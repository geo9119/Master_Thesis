...
Althought the GBDT's at first seem to be better candidate for a more precise mass calculation, the BDT's 
proved to be the ones that offered a better one. That is because the resulting number of events in the BDT 
method are more than the ones in GBDT implying that having stronger signal than better separation between 
signal background is preferable to the case of the mass calculation of the $\tilde{t}$ in CLIC experiment.
...
-isolate leptons
-further investigation of the contradiccion of bdt gbdt
-look at other decays of the stop
-
?????
