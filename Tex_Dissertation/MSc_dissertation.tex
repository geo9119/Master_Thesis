...
\begin{figure}[ht!]
  ...
  \caption{\scriptsize{Signal, SM background and SUSY background after the TMVA application.}}
\end{figure}
...
of the histogram. The templates are summarised in the table below.
...
\centering
  ...
  \caption{\scriptsize{The $\chi^{2}$ versus the different top squark mass templates.}}
\end{figure}
