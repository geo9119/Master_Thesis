...
His comments and technical help proved to be valuable, thus I owe a big thank you to Alan Taylor (UoE).

Additionally I would like to express my gratitude towards the CLICdp team that helped me. Especially
...
If the above histogram is compaired with the corresponding one for 1000 trees (Figure 4.12), then it is clear
...
In the following histogram the ROC curve can be seen that 

\chapter{Conclusions}


The mass of the supersymmetric top quark was calculated for the CLIC experiment at $\surd s$ = 3 TeV and for 
an integrated luminosity $\mathcal{L}_{int}$ = 300 fb$^{-1}$.
...
,i.e. the hadronic channe, we can possobly achieve even smaller uncertainty in the mass calculation of the top
squark.
...
the signal efficiency. Then, repeat the procedure for all the variables besides one and plot again the same 
